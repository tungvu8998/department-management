...
//        AccessDeniedHandler: lỗi 403 lỗi xử lý đăng nhập
//        AuthenticationEntryPoint : lô 401 quyền đăng nhập
         {
    @Autowired
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        for (FieldError fieldError : exception.getFieldErrors()) {// getFieldErrors(): lấy ra tất cả các lỗi về trường
